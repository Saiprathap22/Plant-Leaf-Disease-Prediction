...
df = pd.read_csv(r"C:\Users\T VENKAT SAI PRATHAP\Downloads\muse_v3.csv")
...
model.load_weights(r"C:\Users\T VENKAT SAI PRATHAP\Downloads\Emotion-based-music-recommendation-system-main\Emotion-based-music-recommendation-system-main\model.h5")
...
with col2:
    if st.button('SCAN EMOTION(Click here)'):
        ...
        while True:
            ...
            face = cv2.CascadeClassifier(r"C:\Users\T VENKAT SAI PRATHAP\Downloads\Emotion-based-music-recommendation-system-main\Emotion-based-music-recommendation-system-main\haarcascade_frontalface_default.xml")
